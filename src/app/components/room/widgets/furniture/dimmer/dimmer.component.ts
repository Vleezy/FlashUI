...
export class DimmerFurniComponent extends ConversionTrackingWidget implements OnInit
{
    ...
    ngOnInit(){
        ...
        $(function(){
            $(".rdsmenu:nth-child(1)").addClass("rdsactive");
        })

        $(".rdsmenu").click(function(){
            console.log("rds mneu click")
            $(".rdsmenu").removeClass("rdsactive");
            $(this).addClass("rdsactive");
        })
    }
