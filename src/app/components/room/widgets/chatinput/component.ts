...
@Component({
    ...
    template: `
    <div id="bottom_chat-input-box"> 
        <div class="bottom-bar-chat">
            <input #chatInputView type="text" class="chat-box" placeholder="{{ 'widgets.chatinput.default' | translate }}" (input)="chatInputView.parentElement.dataset.value = chatInputView.value" [maxLength]="inputMaxLength" />
        </div>
