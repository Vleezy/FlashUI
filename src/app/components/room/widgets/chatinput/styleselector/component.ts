...
@Component({
    ...
    <div class="nitro-room-chatinput-styleselector-component">
        <img class="bubble-select-box" src="./assets/images/bottombar/bubble-select.png" (click)="toggleSelector()"> 
        <div [bringToTop] class="nitro-chatstyle-selector" [ngClass]="{ 'active': showStyles }">
            <div class="grid-container w-100">
                <div class="grid-items grid-3">
                    <div class="d-flex flex-column item-detail justify-content-center align-items-center" *ngFor="let styleId of styleIds">
                        <div class="d-flex detail-info rounded justify-content-center align-items-center" [ngClass]="[ ((lastSelectedId === styleId) ? 'bg-white' : 'bg-') ]">
