...
@Component({
    ...
    <div #activeView class="nitro-room-avatarinfo-ownavatar-component context-menu">
        <div class="card align-items-center" style="min-width: 110px;">
        ...
        <div class="userinfobottom"><i class="i icon okico"></i></div>
        ...
        this.menu = [
            {
                ...
                items: [
                    ...
                    {
                        name: 'change_looks',
                        localization: '<u> Görünüm Değiştir </u>',
                        visible: true
                    },
                    {
                        name: 'dance_menu',
                        localization: 'Dans Et <img class="amkico" src="/assets/images/amk.png">',
                    ...
                    {
                        name: 'expressions',
                        localization: 'Eylemler <img class="amkico" src="/assets/images/amk.png">',
                        visible: true
                    },
                    {
                        name: 'signs',
                        localization: 'İşaretler <img class="amkico" src="/assets/images/amk.png">',
                        visible: true
                    },
                    {
                        name: 'drop_hand_item',
